...
* 輸入/輸出欄位：
  ...
  * 單路段選擇工具-輸出欄位：LinkID、Bearing、 RoadID、RoadName、RoadClass、RoadDirection、Version。
  
  * 多路段選取工具-輸出欄位：LinkID、Bearing、 RoadID、RoadName、RoadClass、RoadDirection、Version。
